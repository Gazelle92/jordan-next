  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          ref={dialogRef}
          className={`w-full px-3 pb-3 h-full overflow-y-auto flex-grow-1 flex flex-col justify-start transition-transform duration-400 scrollbar application_bar mb-[10px] ${open
